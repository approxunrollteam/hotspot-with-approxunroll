...
class CountedLoopNode : public LoopNode {
  ...
  //Indicates if the loop has been approximated
  bool _approximate;
...
public:
  ...
  bool is_approximate() {return _approximate;}
  
  void set_approximate(bool val) { _approximate = val; }
...
class PhaseIdealLoop : public PhaseTransform {
  ...
  friend class DegradedUnrollingKit;
