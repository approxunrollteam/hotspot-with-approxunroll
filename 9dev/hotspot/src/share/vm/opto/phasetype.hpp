...
class CompilerPhaseTypeHelper {
  ...
  static const char* to_string(CompilerPhaseType cpt) {
    switch (cpt) {
      ...
      case PHASE_TRACE_POINT_1:                return "Trace Point - 1";
      case PHASE_TRACE_POINT_2:                return "Trace Point - 2";
      case PHASE_TRACE_POINT_3:                return "Trace Point - 3";
      case PHASE_TRACE_POINT_4:                return "Trace Point - 4";
      default:
        ShouldNotReachHere();
        return NULL;
    }
